  ...
  const adPackages = [
    {
      ...
      features: [
        ...
        "Professional ad creatives aligned with your brand story",
        ...
        "Content: 3 posts (property/value-based)",
        "1 short-form video (reel-style) repurposed from your existing content",
      ],
      ideal:
        "Perfect for realtors testing if their brand message and listings resonate with premium buyers.",
      cta: "Start Discovery",
    },

    {
      ...
      features: [
        ...
        "Advanced targeting for high-intent buyers & sellers",
        "Emotion-based messaging for listings",
        "Story-driven content direction",
        "Multiple ad variations + testing",
        "A/B optimization",
        "Weekly performance monitoring & reporting",
        "Lead tracking + follow-up journey design",
        "Monthly brand & content analysis",
        "Monthly strategy call (client journey + content direction)",

        // Social Media Content
        "Social Media Platforms: Facebook, Instagram & TikTok",
        "Content: 8 posts per month (mix of listings, stories, brand-building)",
        "4 short-form videos/month (Reels/TikTok)",
      ],
      ideal:
        "Ideal for realtors who want to position themselves as trusted advisors and build consistent emotional connection with their audience.",
      cta: "Partner With Us",
    },

    {
      ...
      features: [
        ...
        "Full content calendar built around emotional storytelling",
        "Premium listing campaigns for new launches",
        "Advanced retargeting systems",
        "Relationship-building email sequences",
        "Trust-focused content strategy",
        ...
        "Content: 15 posts per month (brand, listings, stories, market education)",
        "8 short-form videos/month (Reels/TikTok/Shorts)",
        "2 long-form YouTube videos/month (property tours or expert content)",
      ],
      ideal:
        "Designed for luxury real estate brands needing a long-term growth partner focused on storytelling, trust, and high-end client engagement.",
